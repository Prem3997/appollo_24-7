...
import '../../styles/Doctor-styles/DoctorComponent.scss'
import {useHistory} from 'react-router-dom';


function CustomCardHooks(props) {
...
<div className="added-doctors">Added Doctors  
    <span className="select2">  <Checkbox 
        ...
        <button type="submit" className="create_admin_button" onClick={props.handleAddRemoveCancel}>CREATE ADMIN</button>
        <button type="button" onClick={props.handleAddRemoveCancel} className="cancel_button">CANCEL</button>
